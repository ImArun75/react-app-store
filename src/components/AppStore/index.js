...
class Appstore extends Component {
  ...
  isActiveTab = () => {
    ...
    const isActiveId = tabsList.map(eachTab => eachTab.tabId === activeTabId)
  ...
  render() {
    ...
    const searchInputList = filteredList.filter(eachItem =>
          ...
          <ul className="buttons-container">
            {tabsList.map(eachTab => (
              <TabItem
                ...
                isActiveId={activeTabId === eachTab.tabId}
              />
            ))}
          </ul>

          <ul className="app-items-container">
            {searchInputList.map(eachApp => (
